...
ViewEdit::ViewEdit(wxFrame* parent) :wxScrolledCanvas(parent, wxID_ANY)
{
    ...
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnMachine1Properties, this, XRCID("Machine1Properties"));
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnMachine2Properties, this, XRCID("Machine2Properties"));
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnSetMachine1StartFrame, this, XRCID("SetMachine1StartFrame"));
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnSetMachine2StartFrame, this, XRCID("SetMachine2StartFrame"));
}
...
/**
 * Update the user interface for Machine>Machine1Properties
 * @param event The event we update
 */
void ViewEdit::OnMachine1Properties(wxCommandEvent& event)
{
    GetPicture()->GetMachineDrawable()->ShowDialogBox(this, 1);
}

/**
 * Update the user interface for Machine>Machine2Properties
 * @param event The event we update
 */
void ViewEdit::OnMachine2Properties(wxCommandEvent& event)
{
    GetPicture()->GetMachineDrawable()->ShowDialogBox(this, 2);
}
 ...
 * @param event The event we update
 */
void ViewEdit::OnSetMachine1StartFrame(wxCommandEvent& event)
{
    GetPicture()->GetMachineDrawable()->SetMachine1StartFrame(GetPicture()->GetTimeline()->GetCurrentFrame());
    GetPicture()->UpdateObservers();
}
 ...
 * @param event The event we update
 */
void ViewEdit::OnSetMachine2StartFrame(wxCommandEvent& event)
{
    GetPicture()->GetMachineDrawable()->SetMachine2StartFrame(GetPicture()->GetTimeline()->GetCurrentFrame());
    GetPicture()->UpdateObservers();
}
