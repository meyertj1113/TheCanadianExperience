...
private:
    ...
    /// The machine drawable being displayed
...
public:
    ...
    */
    ...
    /**
     * Set a pointer to machine drawable
     * @param drawable machine drawable pointer
     */
    void SetMachineDrawable(std::shared_ptr<MachineDrawable> drawable) {mMachineDrawable = drawable;}

    /**
    * Get a pointer to machine drawable
    * @return machine drawable pointer
    */
